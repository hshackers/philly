...
Meetup.add({
	...
	place: { type: String, required: false, initial: true, width: 'medium', default: 'Devnuts - 908 N 3rd St', note: 'Something like Level 6, 341 George St (Atlassian)' },
	map: { type: String, required: false, initial: true, width: 'medium', default: '908 N 3rd St', note: 'Map-friendly address' },
	...
	cover: { type: Types.Url, width: 'medium' },
